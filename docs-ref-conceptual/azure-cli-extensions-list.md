...
| [azure-cli-iot-ext](https://github.com/azure/azure-iot-cli-extension) | 0.4.4 | Fornece a camada de comandos do plano de dados para o Azure Hub IoT, IoT Edge e o Serviço de Provisionamento de Dispositivos |  |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions) | 0.1.0 | Fornece uma visualização para recursos de armazenamento futuras. | sim |
