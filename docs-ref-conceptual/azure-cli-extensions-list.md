...
| [versão prévia do aks](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.6 | Fornece uma versão prévia para futuros recursos do AKS | Sim |
...
| [sap-hana](https://github.com/Azure/azure-hanaonazure-cli-extension) | 0.5.3 | Comandos adicionais para trabalhar com instâncias do SAP HanaOnAzure. |  |
...
| [webapp](https://github.com/Azure/azure-cli-extensions/tree/master/src/webapp) | 0.2.23 | Comandos adicionais para o Serviço de Aplicativo do Azure. | Sim |