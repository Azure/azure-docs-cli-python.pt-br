...
| [versão prévia do aks](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.3 | Fornece uma versão prévia para futuros recursos do AKS | Sim |
...
| [azure-cli-ml](https://docs.microsoft.com/en-us/azure/machine-learning/service/) | 1.0.43 | Módulo de Comando do AzureML para as Ferramentas da Linha de Comando do Microsoft Azure |  |
| [azure-devops](https://github.com/Microsoft/azure-devops-cli-extension) | 0.10.0 | Ferramentas para gerenciar o Azure DevOps. |  |
| [azure-firewall](https://github.com/Azure/azure-cli-extensions/tree/master/src/azure-firewall) | 0.1.2 | Gerenciar recursos do Firewall do Azure. | Sim |
| [db-up](https://github.com/Azure/azure-cli-extensions/tree/master/src/db-up) | 0.1.12 | Comandos adicionais para simplificar os fluxos de trabalho do Banco de Dados do Azure. | Sim |
| [dev-spaces](https://github.com/Azure/azure-cli-extensions) | 1.0.1 | Os Espaços de Desenvolvimento fornecem uma experiência de desenvolvimento Kubernetes rápida e iterativa para equipes. |  |
...
| [eventgrid](https://github.com/Azure/azure-cli-extensions) | 0.4.2 | Módulo de Comando do EventGrid para as Ferramentas da Linha de Comando do Microsoft Azure. | Sim |
...
| [front-door](https://github.com/Azure/azure-cli-extensions/tree/master/src/front-door) | 0.1.6 | Gerenciar FrontDoors de rede. | Sim |
...
| [malha](https://github.com/Azure/azure-cli-extensions) | 0.10.5 | Suporte para a Malha do Microsoft Azure Service Fabric - Visualização Pública | Sim |
| [mixed-reality](https://github.com/Azure/azure-cli-extensions) | 0.0.1 | Extensão da CLI da Realidade Misturada do Azure. |  |
| [netappfiles-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/netappfiles-preview) | 0.3.0 | Fornece uma versão prévia para os futuros recursos do ANF (Azure NetApp Files). | Sim |
| [privatedns](https://github.com/Azure/azure-cli-extensions) | 0.1.0 | Comandos para gerenciar zonas DNS privadas | Sim |
| [resource-graph](https://github.com/Azure/azure-cli-extensions/tree/master/src/resource-graph) | 0.1.10 | Suporte para consultar recursos do Azure com o Resource Graph. | Sim |
| [sap-hana](https://github.com/Azure/azure-hanaonazure-cli-extension) | 0.3.7 | Comandos adicionais para trabalhar com instâncias do SAP HanaOnAzure. |  |
| [storage-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/storage-preview) | 0.2.6 | Fornece uma visualização para recursos de armazenamento futuras. | Sim |
...
| [vm-repair](https://github.com/Azure/azure-cli-extensions/tree/master/src/vm-repair) | 0.1.0 | Comandos de reparo automático para corrigir as VMs. |  |
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.17 | Comandos adicionais para o Serviço de Aplicativo do Azure. | Sim |