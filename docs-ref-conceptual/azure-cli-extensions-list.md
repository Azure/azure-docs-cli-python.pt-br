...
| [azure-batch-cli-extensions](https://github.com/Azure/azure-batch-cli-extensions) | 2.5.0 | Comandos adicionais para trabalhar com o serviço de Lote do Azure |  |
...
| [express-route](https://github.com/Azure/azure-cli-extensions/tree/master/src/express-route) | 0.1.0 | Gerenciar ExpressRoute com versão prévia dos recursos. | SIM |
...
| [front-door](https://github.com/Azure/azure-cli-extensions/tree/master/src/front-door) | 0.1.0 | Gerenciar FrontDoors de rede. | SIM |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/storage-preview) | 0.1.5 | Fornece uma visualização para recursos de armazenamento futuras. | SIM |
...
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.9 | Comandos adicionais para o Serviço de Aplicativo do Azure. | SIM |
