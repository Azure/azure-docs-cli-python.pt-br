...
| [versão prévia do aks](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.17 | Fornece uma versão prévia para futuros recursos do AKS | Sim |
