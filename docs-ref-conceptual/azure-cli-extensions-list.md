...
| [express-route](https://github.com/Azure/azure-cli-extensions/tree/master/src/express-route) | 0.1.2 | Gerenciar ExpressRoute com versão prévia dos recursos. | SIM |
